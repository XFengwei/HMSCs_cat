...
def point_test(x, y):
    ...
    Tdust_point = Tdust[x][y]
    Nh2_point = Nh2[x][y]
    cont070_point = data070[x][y]
    cont160_point = data160[x][y]
    cont250_point = data250[x][y]
    cont350_point = data350[x][y]
    cont500_point = data500[x][y]
    cont870_point = data870[x][y]
