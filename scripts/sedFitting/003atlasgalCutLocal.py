...
outDir = '../../fitsDir/sedFitting/ATLASGAL/'

data_dir = '/Volumes/Sailor_2T/ATLAS_GAL/all_data/'
hdr_dir = '/Volumes/Sailor_2T/ATLAS_GAL/hd_dir/'
list_dir = '/Volumes/Sailor_2T/ATLAS_GAL/list_dir/'
